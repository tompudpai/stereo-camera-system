...
% NumThetas_R = 21;
% 
% % For selecting Rho values 1:36 (1-based index:379:415) WRONG: 379:415 (1-based index: 1:36)
% startIdxRho_L = 380;
% NumRhos_L = 36;
% 
...
%hVideoSrc = vision.VideoFileReader('Activity1_Signs_Left_CSULA.mp4');
...
%     OutMsgPre = OutMsg;
    ...
    [rows, cols, ~] = size(RGB);
    RGB = insertText(RGB, [1 rows], 'CSULA', 'AnchorPoint', 'LeftBottom', 'FontSize',20, 'BoxOpacity', 0);
